...
<%
    ...
    String tr_url       = "https://hansungvote.com/sample3";      // 본인인증 결과수신 POPUP URL
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <div class="login-form bg-white mt-4 p-4 rounded">
                    ...
                    되는 개인정보파일에 대하여 적용되므로 선거관리위원회 선거관리, 선거운동본부 사무관리 및 그 밖에 이에 준하는 선거관리위원회의 업무와 관련된 사항을 기록한 개인정보파일 등은 본 방침의 적용에서 제외됩니다.<br>
                    <br>
                    이 방침은 중앙선거관리위원회에서 운영하는 온라인투표시스템에 적용되며, 본 처리방침은 수시로 내용이 변경될 수 있으니 정기적으로 방문하여 확인하시기 바랍니다.<br>
                    <br>
                    개인정보법 등 관련 법규에 의거하여 상기 본인은 위와 같이 개인정보와 고유식별정보 수집 및 이용에 동의합니다.<br>
                </div>
            </div>
        </div>
    </div>
